            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title">Top Used Tags</h4>
                    </div>
                    <p class="card-description mb-1">Top Used Tags In Blog..</p>
    ...
    <div class="row">
        <div class="col-xl-12 ">
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Type Articles</h4>
                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                            href="#modaldemo8" dir="ltr">Add New..</a>
                    </div>
                    <p class="tx-12 tx-gray-500 mb-2">All Types Article..</p>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-10p border-bottom-0">Time Added</th>
                                    <th class="wd-15p border-bottom-0">Operating</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i = 1; ?>
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <form method="POST" action="{{ route('types-tags.store') }}" class="modal-content modal-content-demo">
                    @csrf
                    <div class="modal-header">
                        <h6 class="modal-title">Add New Type..</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" name="name" placeholder="Title Type..">
                        </div>
                    </div>
        ...
        <div class="modal" id="modaldemo6">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <form method="POST" action="{{ route('types-tags.update', 'error') }}"
                    class="modal-content modal-content-demo">
                    @method('PATCH')
                    @csrf
                    <div class="modal-header">
                        <h6 class="modal-title">Edit In Name Type..</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
        ...
        <div class="modal" id="modaldemo5">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <form method="POST" action="{{ route('types-tags.destroy', 'Error Updateing') }}"
                    class="modal-content modal-content-demo">
                    @method('DELETE')
                    @csrf
                    <div class="modal-header">
                        <h6 class="modal-title">Delete Type..</h6><button aria-label="Close" class="close"
                            data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
