        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'index')) }}">
                    ...
                    <span class="side-menu__label">For You</span><span
            ...
            @auth
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . ($page = 'favorite')) }}">
                        ...
                        <span class="side-menu__label">Favorite</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . ($page = 'settings')) }}">
                        <ion-icon name="settings" class="icon side-menu__icon"></ion-icon>
                        <span class="side-menu__label">Settings</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="{{ url('/' . ($page = 'statistic_user')) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        <span class="side-menu__label">Statistics</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            <path
                                d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z" />
                        </svg><span class="side-menu__label">Owner</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'statistic_owner')) }}">Statistics</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'articles')) }}">Articles</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'types-tags')) }}">Types & Tags</a></li>
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">Users</a></li>
                    </ul>
                </li>
            @endauth
            @guest
                <p class="text-inline text-secondary text-center" dir="ltr">We Have More But Login First...</p>
            @endguest
        </ul>
        <hr>
        <ul class="side-menu">
